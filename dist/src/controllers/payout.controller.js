...
const getPayoutHistory = async (req, res)=>{
    try {
        ...
        const payouts = await _payoutservice.payoutService.getPayoutHistory(userId, Number(page), Number(limit));
        res.json({
            success: true,
            data: payouts
        });
...
const triggerBookingPayout = async (req, res)=>{
    try {
        ...
        const payout = await _payoutservice.payoutService.processBookingPayout(bookingId);
        res.json({
            success: true,
